...
def generate_masked_orthogonal_rank_groups(
    ...
    Algorithm:
        For orthogonal parallelism, such as tp/dp/pp/sp, the global_rank and
...
class RankGenerator(object):
    ...
    def __init__(
        self, tp: int, dp: int, pp: int, sp1: int, sp2: int, order: str, rank_offset: int = 0
    ) -> None:
        self.tp = tp
        self.dp = dp
        self.pp = pp
        ...
        self.world_size = tp * dp * pp * sp1 * sp2
